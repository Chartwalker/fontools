...
TSC_PRJG_FNAME="fontools"
TSC_PRJG_PNAME="fontools"
TSC_PRJG_PSUMS="App für Analyse von Erwartungswerten und Streuungen"
TSC_PRJG_PSUML="App für Analyse von Erwartungswerten und Streuungen"
